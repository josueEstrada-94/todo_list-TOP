...
/***/ "./src/modules/renderChecklist.js":
/*!****************************************!*\
  !*** ./src/modules/renderChecklist.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   renderChecklistItems: () => (/* binding */ renderChecklistItems)\n/* harmony export */ });\nfunction renderChecklistItems(task) {\n    const checklistContainer = document.querySelector('.todo-ul');\n\n    // Clear existing checklist items\n    checklistContainer.innerHTML = '';\n\n    if (task.checklist && task.checklist.length > 0) {\n        task.checklist.forEach(item => {\n            const li = document.createElement('li');\n            li.textContent = item;\n            checklistContainer.appendChild(li);\n        });\n    }\n}\n\n\n//# sourceURL=webpack://todo_list-top/./src/modules/renderChecklist.js?");
